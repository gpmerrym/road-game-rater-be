...
public class SeedData {
	...
	public SeedData(PlaceRepository placeRepo, RatingInfoRepository ratingInfoRepo) {
		...
		RatingInfo info8 = new RatingInfo(4, true, true, true, "enjoyable");
		RatingInfo info9 = new RatingInfo(4, true, true, true, "pretty good");
		RatingInfo info10 = new RatingInfo(5, true, true, true, "Great");
