...
public class SeedData {
	...
	public SeedData(PlaceRepository placeRepo, RatingInfoRepository ratingInfoRepo, UserRepository userRepo,
		...
		RatingInfo rating1 = new RatingInfo(4, false, false, false, "not so bad", null);
		
		RatingInfo rating2 = new RatingInfo(4, true, false, true, "good", null);
		RatingInfo rating3 = new RatingInfo(3, false, true, true, "great", null);
		RatingInfo rating4 = new RatingInfo(3, true, false, true, "average", null);
		RatingInfo rating5 = new RatingInfo(4, false, true, true, "bad", null);
		RatingInfo rating6 = new RatingInfo(4, false, true, true, "soso", null);
		RatingInfo rating7 = new RatingInfo(5, false, true, true, "gooood", null);
		RatingInfo rating8 = new RatingInfo(2, false, true, true, "bad", null);
		RatingInfo rating9 = new RatingInfo(4, true, true, false, "good", null);
		RatingInfo rating10 = new RatingInfo(3, true, true, false, "good", null);
		RatingInfo rating11 = new RatingInfo(4, true, false, true, "good", null);
		RatingInfo rating12 = new RatingInfo(3, true, false, true, "goodie", null);
		RatingInfo rating13 = new RatingInfo(5, false, true, true, "gooood", null);
		RatingInfo rating14 = new RatingInfo(2, false, true, true, "bad", null);
		RatingInfo rating15 = new RatingInfo(4, true, true, false, "good", null);
		RatingInfo rating16 = new RatingInfo(3, true, true, false, "good", null);
		RatingInfo rating17 = new RatingInfo(4, true, false, true, "good", null);
		RatingInfo rating18 = new RatingInfo(5, true, false, true, "good", null);
		RatingInfo rating19 = new RatingInfo(3, true, true, false, "good", null);
		RatingInfo rating20 = new RatingInfo(4, true, false, true, "good", null);
		RatingInfo rating21 = new RatingInfo(3, true, false, true, "good", null);
		RatingInfo rating22 = new RatingInfo(1, true, false, true, "good", null);
		RatingInfo rating23 = new RatingInfo(2, true, false, true, "good", null);
		RatingInfo rating24 = new RatingInfo(3, true, false, true, "good", null);
		RatingInfo rating25 = new RatingInfo(2, true, false, true, "good", null);
		RatingInfo rating26 = new RatingInfo(3, true, false, true, "good", null);
		RatingInfo rating27 = new RatingInfo(4, true, false, true, "good", null);
		RatingInfo rating28 = new RatingInfo(1, true, false, true, "good", null);
		RatingInfo rating29 = new RatingInfo(2, true, false, true, "good", null);
		RatingInfo rating30 = new RatingInfo(5, true, false, true, "good", null);
		RatingInfo rating31 = new RatingInfo(2, true, false, true, "good", null);
		RatingInfo rating32 = new RatingInfo(5, true, false, true, "good", null);
		RatingInfo rating33 = new RatingInfo(3, true, false, true, "good", null);
		RatingInfo rating34 = new RatingInfo(2, true, false, true, "good", null);
		RatingInfo rating35 = new RatingInfo(1, true, false, true, "good", null);
		RatingInfo rating36 = new RatingInfo(5, true, false, true, "good", null);
		RatingInfo rating37 = new RatingInfo(4, true, false, true, "good", null);
		RatingInfo rating38 = new RatingInfo(3, true, false, true, "good", null);
		RatingInfo rating39 = new RatingInfo(5, true, false, true, "good", null);
		RatingInfo rating40 = new RatingInfo(1, true, false, true, "good", null);
